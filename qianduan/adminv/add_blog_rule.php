...
<body>
  <div class="bgintor">
	...
	<div class="listintor">
		...
		<div class="content">
		<form  method="post" action="blog_rule_do.php?op=add">
          <div class="SiteEdit">
			...
			<p><label>评论数开始标记：</label><input class="L200" type="text" name="comment_b"/><label>　　　　　评论数结束标记：</label><input class="L200" type="text" name="comment_e"/></p>
			<p>示例：<span style="margin-right:160px;">&lt;div id="comment_num"&gt;</span><span style="margin-left:80px;">&lt;/div&gt;</span></p>
			<p><label>阅读数开始标记：</label><input class="L200" type="text" name="read_b"/><label>　　　　　阅读数结束标记：</label><input class="L200" type="text" name="read_e"/></p>
