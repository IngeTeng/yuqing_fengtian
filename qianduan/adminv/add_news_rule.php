...
<body>
  <div class="bgintor">
	...
	<div class="listintor">
		...
		<div class="content">
		<form  method="post" action="news_rule_do.php?op=add">
          <div class="SiteEdit">
			...
			<p><label>评论开始标记：</label><input class="L200" type="text" name="comment_b"/><label>　　　　　评论结束标记：</label><input class="L200" type="text" name="comment_e"/></p>
			<p>示例：<span style="margin-right:160px;">&lt;div id="comment_num"&gt;</span><span style="margin-left:60px;">&lt;/div&gt;</span></p>
			...
			<p><label>来源开始标记：</label><input class="L200" type="text" name="source_b"/><label>　　　　　来源结束标记：</label><input class="L200" type="text" name="source_e"/></p>
			<p>示例：<span style="margin-right:160px;">&lt;div id="source"&gt;</span><span style="margin-left:90px;">&lt;/div&gt;</span></p>
			<p><label>频道开始标记：</label><input class="L200" type="text" name="channel_b"/><label>　　　　　频道结束标记：</label><input class="L200" type="text" name="channel_e"/></p>
			<p>示例：<span style="margin-right:160px;">&lt;div id="channel"&gt;</span><span style="margin-left:85px;">&lt;/div&gt;</span></p>
  	     </div>
  	     <ul class="Botton">
