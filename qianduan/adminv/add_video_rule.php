...
<body>
  <div class="bgintor">
		<div class="tit1">
			<ul>
				<li class="l1"><a href="video_rule_list.php" target="mainFrame">提取规则列表</a> </li>
	...
	<div class="listintor">
		...
		<div class="content">
		<form  method="post" action="video_rule_do.php?op=add">
          <div class="SiteEdit">
			...
			<p>示例：<span style="margin-right:160px;">&lt;div id="media"&gt;</span><span style="margin-left:85px;">&lt;/div&gt;</span></p>
			...
			<p>示例：<span style="margin-right:160px;">&lt;div id="channel"&gt;</span><span style="margin-left:75px;">&lt;/div&gt;</span></p>
			<p><label>摘要开始标记：</label><input class="L200" type="text" name="summary_b"/><label>　　　　　摘要结束标记：</label><input class="L200" type="text" name="summary_e"/></p>
			<p>示例：<span style="margin-right:160px;">&lt;div id="summary"&gt;</span><span style="margin-left:75px;">&lt;/div&gt;</span></p>
