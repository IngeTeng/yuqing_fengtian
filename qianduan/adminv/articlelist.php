			...
			<div class="listintor">
				...
				<div class="content">
					<form action="#" method ="post" name="listForm">
						<table width="100%">
							...
							<?php
								//分页
								$pagesize = 10;
								$sql_page = "select article_id from info_article";
								...
								$sql = "select info_article.*,info_sort.parent_id, info_sort.parent_name,info_sort.sort_name from info_article join info_sort on info_article.article_sort = info_sort.sort_id order by sort_weight desc, article_createtime desc limit ".$pagestart.",".$pagesize;
								$rs = mysql_query($sql);
					...
					<div class="page">
						...
						<div class="pageafter">
						<?php echo showPage('articlelist.php',$page,$pagecount);?>
						<div class="clear"></div>
						</div>
					</div>
					<?php }?>
