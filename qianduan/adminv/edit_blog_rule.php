...
<body>
  <div class="bgintor">
		<div class="tit1">
			<ul>
				<li class="l1"><a href="blog_rule_list.php" target="mainFrame">提取规则列表</a> </li>
	...
	<div class="listintor">
		...
		<div class="content">
		<form  method="post" action="blog_rule_do.php?op=edit">
          ...
          <div class="SiteEdit">
			...
			<p>示例：<span style="margin-right:160px;">&lt;div id="media"&gt;</span><span style="margin-left:97px;">&lt;/div&gt;</span></p>
			<p><label>评论数开始标记：</label><input class="L200" type="text" name="comment_b" id="comment_b"/><label>　　　　　评论数结束标记：</label><input class="L200" type="text" name="comment_e" id="comment_e"/></p>
			<p>示例：<span style="margin-right:160px;">&lt;div id="comment_num"&gt;</span><span style="margin-left:80px;">&lt;/div&gt;</span></p>
			<p><label>阅读数开始标记：</label><input class="L200" type="text" name="read_b" id="read_b"/><label>　　　　　阅读数结束标记：</label><input class="L200" type="text" name="read_e" id="read_e"/></p>
			<p>示例：<span style="margin-right:160px;">&lt;div id="read_num"&gt;</span><span style="margin-left:100px;">&lt;/div&gt;</span></p>
  	     </div>
  	     <ul class="Botton">
...
$.ajax({
   ...
   success:function(data){
		...
		$('#read_b').val(data['read_b']);
		$('#read_e').val(data['read_e']);
   }
})
</script>
