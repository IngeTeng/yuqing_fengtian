...
<body>
  <div class="bgintor">
	...
	<div class="listintor">
		...
		<div class="content">
		<form  method="post" action="video_rule_do.php?op=edit">
          ...
          <div class="SiteEdit">
			...
			<p><label>摘要开始标记：</label><input class="L200" type="text" name="summary_b" id="summary_b"/><label>　　　　　摘要结束标记：</label><input class="L200" type="text" name="summary_e" id="summary_e"/></p>
...
$.ajax({
   ...
   success:function(data){
		...
		$('#summary_b').val(data['summary_b']);
		$('#summary_e').val(data['summary_e']);
   }
})
</script>
