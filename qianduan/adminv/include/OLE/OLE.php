...
//define("EXCEL_WRITER_ROOT",  substr(dirname ( __FILE__ ) ,0,-3));

require_once EXCEL_WRITER_ROOT.'PEAR.php';
...
class OLE extends PEAR
{
    ...
    */
    ...
    {
        include_once 'pear_excel/OLE/ChainedBlockStream.php';
    ...
    function _readPpsWks($blockId)
    {
        ...
        for ($pos = 0; ; $pos += 128) {
            ...
            case OLE_PPS_TYPE_ROOT:
                require_once 'pear_excel/OLE/PPS/Root.php';
            ...
            case OLE_PPS_TYPE_FILE:
                require_once 'pear_excel/OLE/PPS/File.php';
