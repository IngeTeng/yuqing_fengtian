...
<div class="Content" style="padding-top:0px;">
		<table border="0" cellspacing="0" cellpadding="0" width="900">
			 ...
			 <?php
			      ...
			      $query="select * from weibo_stats where stats_time=$yesterday_start and uk_id in (".$uk_ids.") order by uk_id asc";
				  $res=mysql_query($query);
			 ...
			 ?>
				   <tr>
						 ...
						 <td>
						      <?php 
							       if($rows['isV']==0)echo "非认证用户";
								   if($rows['isV']==1)echo "认证用户";
							  ?>
						 </td>
