...
$query="select article_id,article_property,id,uk_id,a_type from news_key where uk_id in (".$uk_ids.") and article_pubtime>$start_time and article_pubtime<$end_time ";
if($audit!="all"){
...
while($row=mysql_fetch_array($res)){
	...
	if(filter($filter_words,$filter_place,$filter_type,$article_title,$article_summary)){	
		...
		$array[$i]['title']=$row2['article_title'];
		$array[$i]['link']=$row2['article_url'];
		$array[$i]['time']=date('Y-m-d',$row2['article_pubtime']);
		...
		$array[$i]['summary']=$row2['article_summary'];
		$array[$i]['a_type']=$type;
...
$width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>40,'G'=>11,'H'=>40,'I'=>6,'J'=>8,'K'=>30,'L'=>15,'M'=>15);
...
unset($array);
$query="select article_id,article_property,id,uk_id,a_type from bbs_key where uk_id in (".$uk_ids.") and article_pubtime>$start_time and article_pubtime<$end_time ";
if($audit!="all"){
	$query.="and audit_status=$audit ";
}
if($property!="all"){
...
$bbs_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>40,'G'=>15,'H'=>40,'I'=>10,'J'=>10,'K'=>10,'L'=>30,'M'=>15,'N'=>15);
...
unset($array);
$query="select article_id,article_property,id,uk_id,a_type from blog_key where uk_id in (".$uk_ids.") and article_pubtime>$start_time and article_pubtime<$end_time ";
if($audit!="all"){
	$query.="and audit_status=$audit ";
}
if($property!="all"){
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>40,'G'=>40,'H'=>10,'I'=>10,'J'=>10,'K'=>30,'L'=>15,'M'=>15);
...
unset($array);
$query="select article_id,article_property,id,uk_id,a_type from weibo_key where uk_id in (".$uk_ids.") and article_pubtime>$start_time and article_pubtime<$end_time ";
if($audit!="all"){
	$query.="and audit_status=$audit ";
}
if($property!="all"){
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>40,'G'=>40,'H'=>10,'I'=>10,'J'=>10,'K'=>12,'L'=>10,'M'=>20,'N'=>10,'O'=>15);
foreach($blog_width_array as $k => $v){
   $objActSheet->getColumnDimension($k)->setWidth($v);
}
foreach($color_array as $v){
...
unset($array);
$query="select article_id,article_property,id,uk_id,a_type from video_key where uk_id in (".$uk_ids.") and article_pubtime>$start_time and article_pubtime<$end_time ";
if($audit!="all"){
	$query.="and audit_status=$audit ";
}
if($property!="all"){
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>40,'G'=>15,'H'=>40,'I'=>15,'J'=>30,'L'=>15);
foreach($blog_width_array as $k => $v){
   $objActSheet->getColumnDimension($k)->setWidth($v);
}
foreach($color_array as $v){
...
$filename_download=iconv('utf8','gbk',$file_name).".xls";    
...
header ('Expires: Mon, 26 Jul 2013 08:00:00 GMT'); // Date in the past
