...
$order=1;//排序方式，发布时间1或采集时间2
$quchong=1;//是否去重 0 不去重 1 去重
$uk_ids=$_POST['uk_ids'];//关键字
$audit=$_POST['audit'];//文章状态
...
while($row=mysql_fetch_array($res)){
    ...
    if(filter($filter_words,$filter_place,$filter_type,$article_title,$article_summary)){
        ...
        if($order == 1 ){ //按发布时间
            ...
            $array[$i]['time']=date('Y-m-d',$row2['article_addtime']);
        }
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>50,'G'=>15,'H'=>67,'I'=>10,'J'=>30,'L'=>15);
...
$bbs_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>50,'G'=>15,'H'=>67,'I'=>10,'J'=>10,'K'=>10,'L'=>30,'M'=>15,'N'=>15);
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>50,'G'=>67,'H'=>10,'I'=>10,'J'=>10,'K'=>30,'L'=>15,'M'=>15);
foreach($blog_width_array as $k => $v){
    $objActSheet->getColumnDimension($k)->setWidth($v);
}
foreach($color_array as $v){
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>10,'E'=>11,'F'=>50,'G'=>50,'H'=>10,'I'=>10,'J'=>10,'K'=>12,'L'=>10,'M'=>20,'N'=>10,'O'=>15);
foreach($blog_width_array as $k => $v){
    $objActSheet->getColumnDimension($k)->setWidth($v);
}
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>11,'E'=>50,'F'=>67,'G'=>10,'H'=>10,'I'=>10,'J'=>10);
foreach($blog_width_array as $k => $v){
    $objActSheet->getColumnDimension($k)->setWidth($v);
}
foreach($color_array as $v){
...
$blog_width_array=array('A'=>5,'B'=>10,'C'=>10,'D'=>11,'E'=>50,'F'=>40,'G'=>67,'H'=>10,'I'=>10);
foreach($blog_width_array as $k => $v){
    $objActSheet->getColumnDimension($k)->setWidth($v);
}
foreach($color_array as $v){
