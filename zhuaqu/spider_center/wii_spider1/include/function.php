...
function handle_one_page($spider_result, $spider_result_path, $content_request, $log) {
  ...
  //       }
    ...
    $content_request['collect_download_url'] = 'http://'. COLLECT_HOST. ':'. COLLECT_PORT. '/yuqing/wii_spider/'. $content_request['spider_kind']. "/spider_result/$spider_result_name";     // 拼接下载地址
