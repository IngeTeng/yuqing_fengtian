 ...
 * @createtime 2016-10-11  23:09:11
 * @updatetime 2016-10-11  23:09:11
 * @version 1.0
 * @Description
 * 
 */
...
//
//$klist = array();
//$klist["凯美瑞"] = "zlts/25-296-0-0-0-0_0-0-1.shtml";
//$klist["雷凌"] = "zlts/25-1469-0-0-0-0_0-0-1.shtml";
//$klist["致炫"] = "zlts/25-1304-0-0-0-0_0-0-1.shtml";
//$klist["汉兰达"] = "zlts/25-297-0-0-0-0_0-0-1.shtml";
//$klist["逸致"] = "zlts/25-994-0-0-0-0_0-0-1.shtml";
//$klist["雅力士"] = "zlts/25-298-0-0-0-0_0-0-1.shtml";
...
//    }
    ...
    for($i=1;$i<3;$i++)
    {
        ...
        while($page <= 10) {
            ...
            $spider_url = sprintf($url_host,urlencode($key_word), $page,$i);     // 构造url
