...
/**
 * @filename baidusearch.php 
 * @encoding UTF-8 
 * @author WiiPu CzRzChao 
 * @createtime 2016-11-13  19:28:57
 * @updatetime 2016-11-13  19:28:57
 * @version 1.0
 * @Description
 * 百度网页搜索,一天之内
 * 
...
$url_host= 'https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&rsv_idx=1&tn=baidu&wd=site:baijiahao.baidu.com %s&pn=%d&rn=%d&rsv_enter=1&gpc=stf%%3D%d%%2C%d%%7Cstftype%%3D1&tfflag=1';
// 遍历关键字    
foreach($task_array['keywords'] as $keyword) {
    ...
    while($page <= Configure::PAGE_NUM) {
        $spider_url = sprintf($url_host, urlencode($key_word), ($page-1)*Configure::ONE_PAGE_NUM, Configure::ONE_PAGE_NUM, strtotime('-1 day'), time());        // 构造url
        $page++;
