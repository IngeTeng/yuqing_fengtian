 ...
 * @createtime 2016-8-9  14:21:40
 * @updatetime 2016-8-9  14:21:40
 * @version 1.0
 * @Description
 * 360问答
 * 
...
//     $spider_result = get_html($spider_url,'', '183.238.100.135', '8080');     // 获取html
//     
...
foreach($task_array['keywords'] as $keyword) {
    ...
    foreach($proxy_infos as $proxy_info) {
        ...
        if(empty($spider_result) or false === strpos($spider_result, '360问答')) {
