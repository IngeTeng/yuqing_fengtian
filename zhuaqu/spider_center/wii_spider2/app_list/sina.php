 ...
 * @createtime 2016-8-14  15:39:29
 * @updatetime 2016-8-14  15:39:29
 * @version 1.0
 * @Description
 * 新浪手机app
 * 
...
$clist = array('news_toutiao', 'news_sports', 'news_ent', 'news_finance', 'news_tech', 'news_auto', 'news_funn', 'local_sha');
$count = count($clist);
for($i = 0; $i < $count; $i++) {
