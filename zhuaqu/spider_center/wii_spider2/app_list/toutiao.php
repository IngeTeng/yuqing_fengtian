 ...
 * @createtime 2016-8-14  22:13:23
 * @updatetime 2016-8-14  22:13:23
 * @version 1.0
 * @Description
 * 今日头条
 * 
...
$clist = array('news_hot', 'news_society', 'news_tech', 'news_car', 'news_entertainment', 'news_finance', 'news_military', 'news_health', 'news_edu');
$count = count($clist);
for($i = 0; $i < $count; $i++) {
