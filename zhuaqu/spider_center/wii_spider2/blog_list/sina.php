 ...
 * @createtime 2016-8-27  10:31:16
 * @updatetime 2016-8-27  10:31:16
 * @version 1.0
 * @Description
 * 新浪博客抓取
 * 
...
require(BASE_PATH. '/blog_list/config.php');
require(BASE_PATH. '/include/log.php');

// 调用命名空间
use SPIDER_CENTER\BLOG_LIST\Configure;
...
foreach($task_array['keywords'] as $keyword) {
    ...
    $spider_url = sprintf($url_host, urlencode(iconv('utf-8', 'gbk', $key_word)));      // 构造url
