...
// 定义当前服务器地址,用于拼接下载地址.....
define("COLLECT_HOST", "172.26.133.70");		// 
...
// 任务中心的地址
define('TASK_CENTER', 'http://172.26.133.69:8088/yuqing/task_center_fengtian_mainkw/task_center.php');
...
// 通用的爬取间隔时间
define('COMMON_SLEEP',3600);//3600
// app爬取时间间隔
define('APP_SLEEP', 800);
...
define('SPIDER_SLEEP', json_encode(array(
    //微博
    'sina_weibo_list' => 5000,
    'sina2_weibo_list' => 600,          
...
//    'google_news_list' => COMMON_SLEEP,     // 谷歌搜索 先不管
    ...
    'autohome-dealer_news_list' => 2*COMMON_SLEEP,       //汽车之家经销商报价
