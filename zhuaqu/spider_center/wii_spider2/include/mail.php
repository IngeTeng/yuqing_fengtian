...
class Mail{
	...
	private $mysmtp_server      = 'smtp.163.com';
	private $mysmtp_port        = 25;
	private $mysmtp_auth        = true;
	private $mysmtp_account     = 'q575118347';//邮箱账号
	private $mysmtp_pass        = 'q534140264';
	private $mailfrom    		= 'q575118347@163.com';
	private $mailto         	= 'stone_movies@126.com';
	private $mailfrom_name   	= 'fengtian-yuqing';
	//SMTP配置结束*************
