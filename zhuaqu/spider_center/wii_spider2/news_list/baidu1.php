 ...
 * @createtime 2016-11-13  18:00:24
 * @updatetime 2016-11-13  18:00:24
 * @version 1.0
 * @Description
 * 百度新闻抓取中心1
 * 跟另一个一样,只不过是url的区别
...
$log = Log::Init(Configure::getLogHandle(BASE_PATH, 'baidu1'), LOG_LEVEL);
...
$url_host = Configure::$url_hosts['baidu1'];        // 获取爬取网址
